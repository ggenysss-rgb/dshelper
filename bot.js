...
config.autoReplies = config.autoReplies || [
    ...
    },
    {
        ...
        includeAny: [
            ...
            'незаслуженный бан', 'незаслуженно забанили', 'бан без причины',
            'забанили без причины', 'заблокировали без причины',
            'ошибочный бан', 'ошибочная блокировка', 'бан ошибка',
            'я не читер', 'я ничего не нарушал', 'я ничего не нарушала',
            'почему меня забанили', 'почему меня заблокировали', 'за что меня забанили',
        ],
        excludeAny: [
            'уже подал апелляц', 'уже подала апелляц', 'уже отправил апелляц',
            'уже написал апелляц', 'уже апелляцию подал', 'апелляция уже подана',
