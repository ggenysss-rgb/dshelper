    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="bg-card border border-border rounded-xl p-6">
                ...
                <Toggle label="Использовать скелетоны загрузки" desc="Показывать мерцающие прямоугольники вместо колечка загрузки" value={s.useSkeletons ?? true} onChange={v => update('useSkeletons', v)} />
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="bg-card border border-border rounded-xl p-6">
                ...
                <div className="py-3 border-b border-border/30 last:border-0">
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5 mb-2">
                        По одному ключу на строку. Поддержка: <code>openrouter:</code>, <code>groq:</code>, <code>gemini:</code>.
                        Примеры: <code>openrouter:sk-or-...</code>, <code>groq:gsk_...</code>, <code>gemini:AIza...</code>.
                        Без префикса тоже работает (авто-детект).
                    </p>
                    <textarea
